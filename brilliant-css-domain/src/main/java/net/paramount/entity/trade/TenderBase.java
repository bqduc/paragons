...
import net.paramount.model.CurrencyRateType;
 ...
 */
@MappedSuperclass
public class TenderBase extends RepoAuditable {
    ...
    private String docCurrency = CommonConstants.SYSTEM_CURRENCY_CODE;//dökümanın döviz tipi bilgisini tutar.
